...
*/
export const githubUsername = "Skepticisme";
...
/* Skills
 ************************************************************** 
  Add or remove skills in the SAME format below, choose icons here -    /
*/
export const skillData = [
  ...
  {
    id: 10,
    skill: <Icon icon="bxl:python" className="display-4" />,
    name: "Python",
  },
  {
    id: 11,
  ...
  {
    id: 16,
    skill: <Icon icon="mdi:php" className="display-4" />,
    name: "PHP",
  },  {
    id: 17,
  ...
  {
    id: 18,
    skill: <Icon icon="bxl:django" className="display-4" />,
    name: "Django",
  },
...
export const resume = "https://drive.google.com/uc?export=download&id=1WYsZrS6hqxKiM5xzDaDa0OKoTXu1FuGl";
 ...
 ************************************************************** 
  ...
  https://formspree.io/
*/
export const formspreeUrl = "https://formspree.io/f/xeqwykzj";
